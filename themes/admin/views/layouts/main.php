                ...
                array(
                    ...
                    'items' => array(
                        ...
                        array('label' => 'Modules', 'icon' => 'icon-th-large', 'url' => '#', 'visible' => !Yii::app()->user->isGuest, 'items' => array(
                                ...
                                array('label' => 'Booking', 'icon' => 'icon-book', 'url' => '#', 'visible' => !Yii::app()->user->isGuest, 'items' => array(                                        
                                        array('label' => 'Booking', 'icon' => 'icon-play', 'url' => array('/booking/admin'), 'visible' => !Yii::app()->user->isGuest),
                                    )),
